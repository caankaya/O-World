          ...
          <div className="space-y-2 font-medium mt-10 mb-10">
            <div className="flex items-center justify-between">
              ...
              <span
                ...
                className={`cursor-pointer transition-transform duration-300 ${isSolarSystemOpen ? 'rotate-0' : '-rotate-180'}`}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
            ...
            <div className={`transition-all duration-300 overflow-hidden hover:border hover-shadow-neon rounded-lg ${isSolarSystemOpen ? 'max-h-screen' : 'max-h-0'}`}>
              <a
                href={`/world`}
                className="flex items-center p-2 text-white font-semibold"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
            ...
            <div className="space-y-2 font-medium mt-10 mb-10">
              <div className="flex items-center justify-between">
                ...
                <span
                  ...
                  className={`cursor-pointer transition-transform duration-300 ${isCountryOpen ? 'rotate-0' : '-rotate-180'}`}
                >
                  <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              <div className={`transition-all duration-300 overflow-hidden ${isCountryOpen ? 'max-h-screen' : 'max-h-0'}`}>
