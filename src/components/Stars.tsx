...
function StarsCanvas() {
  // Ceci est le composant principal qui crée la scène 3D. Il utilise le composant Canvas de @react-three/fiber pour créer la scène, et le composant Stars pour créer le nuage de points.
  return (
